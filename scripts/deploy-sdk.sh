...
# example
#   QUINCE_SDK_DEPLOY_DIR  : sdk-quince-image-minimal-raspberrypi3-64
#   SDKDEPLOYDIR           : tmp/work/raspberrypi3_64-quince-linux/quince-image-minimal/1.0/x86_64-deploy-quince-image-minimal-populate-sdk
#   TOOLCHAIN_OUTPUTNAME   : sdk-quince-image-minimal-raspberrypi3-64-toolchain-5.0.8
